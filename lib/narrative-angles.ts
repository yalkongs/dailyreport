...
1년 전, 3년 전, 5년 전 오늘의 시장 상황과 비교하세요.
"1년 전 오늘 코스피는 2,500이었고 원/달러는 1,320원이었습니다. 그 사이 무엇이 바뀌었을까요?"
...
오늘 시장 변화를 구체적인 직업의 하루에 대입하세요.
예: 수출 중소기업 사장님의 환율 계산기, 카페 사장님의 원두 가격표, 택시 기사님의 LPG 가격
추상적 "일반인"이 아닌 구체적 인물의 시선으로 시장을 풀어주세요.`,
  },
  {
    id: "structural_lens",
    name: "구조적 렌즈",
