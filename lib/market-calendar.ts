...
const KR_HOLIDAYS: Record<number, Holiday[]> = {
  2026: [
    ...
    // 제헌절: 2026년부터 재지정된 법정 공휴일 → KRX 휴장.
    //   (2008~2025는 공휴일 아니어서 KRX 개장이었음 — "실수"로 착각해 제거 금지.)
    //   향후 연도(2027+) 추가 시에도 07-17 포함 필수. 주말이면 대체공휴일 규칙 확인.
    { date: "2026-07-17", name: "제헌절 (재지정 법정공휴일)" },
